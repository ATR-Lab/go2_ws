        ...
        return [
            ...
            Node(
                ...
                parameters=[{
                    ...
                    'polygons': ['FootprintStop', 'FootprintApproach'],
                    'observation_sources': ['scan'],
                    # FootprintStop configuration
                    'FootprintStop.type': 'polygon',
                    'FootprintStop.action_type': 'stop',
                    'FootprintStop.footprint_topic': '/local_costmap/published_footprint',
                    'FootprintStop.time_before_collision': 0.2,
                    'FootprintStop.simulation_time_step': 0.05,
                    'FootprintStop.min_points': 4,
                    'FootprintStop.visualize': True,
                    'FootprintStop.enabled': True,
                    # FootprintApproach configuration  
                    'FootprintApproach.type': 'polygon',
                    'FootprintApproach.action_type': 'stop',
                    'FootprintApproach.footprint_topic': '/local_costmap/published_footprint',
                    'FootprintApproach.time_before_collision': 0.3,
                    'FootprintApproach.simulation_time_step': 0.1,
                    'FootprintApproach.min_points': 6,
                    'FootprintApproach.visualize': True,
                    'FootprintApproach.enabled': True,
                    # Scan sensor configuration
                    'scan.type': 'scan',
                    'scan.topic': 'scan_restamped',
                    'scan.min_height': 0.15,
                    'scan.max_height': 2.0,
                    'scan.enabled': True
                }],
