...
The Sui Indexer monitors and indexes events from the coffee club smart contract on Sui. It tracks cafe creation and coffee order events, storing them in a local database and publishing them to ROS2 topics for other nodes to consume.
...
For example:
```bash
ros2 launch sui_indexer indexer.launch.py "package_id:='0x2ee032ffc863a74a785ac3003fb8b61d639d9095b4431fdc1b12181c0a2a8c13'"
```
