#!/usr/bin/env python3
"""
Test System Launch File (RViz2 Version)

Launches the complete test system for the robot dog petting zoo using RViz2:
...
- rviz_visualizer: RViz2-based visualization (no Qt conflicts)

This version avoids PyQt5 conflicts by using ROS2's built-in RViz2.
"""
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'enable_visualizer',
            default_value='true',
            description='Enable RViz2 visualization node'
        ),
        
        DeclareLaunchArgument(
            'enable_rviz',
            default_value='true',
            description='Launch RViz2 application'
        ),
        ...
        Node(
            ...
            parameters=[{
                ...
                'enable_preview': False  # Disable OpenCV preview since we have RViz2
            }]
        ),
